...
void show_histogram_svg(const vector<size_t>& bins, const string& decoration) {
	...
	for (size_t bin : bins) {
		...
		if (max_count <= MAX_ASTERISK) {
			...
			bin_width = MAX_ASTERISK * (static_cast <double> (bin) / max_count);
		}
